...
export async function cargarUniversoCompleto() {
  ...
  const sql = `
    ...
    SELECT
      ...
      s.score_valuation, s.score_deep_value, s.score_profitability, s.score_growth,
      s.score_financial, s.score_momentum_calidad, s.score_fundamental_momentum, s.score_income,
      s.graham_margin_of_safety AS screener_graham_margin_of_safety,
      s.fcf_yield AS screener_fcf_yield,
      s.analyst_upside AS screener_analyst_upside,
      s.trailingPE_vs_historia, s.priceToBook_vs_historia,
      s.rsi_14 AS screener_rsi_14, s.current_drawdown AS screener_current_drawdown,
      ...
      s.tendencia_semanal_alcista, s.semanas_desde_golden_cross,
      s.semanas_desde_death_cross, s.señal_tendencia,
